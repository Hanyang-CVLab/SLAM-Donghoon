...
// #include <g2o/g2o/types/slam3d/types_slam3d.h>
...
namespace dhSLAM{
    ...
    // void addPoseVertex( g2o::SparseOptimizer* optimizer, 
    //                     g2o::SE3Quat& pose, 
    //                     bool set_fixed, 
    //                     int id);
    
    // void addEdgePosePose(   g2o::SparseOptimizer* optimizer, 
    //                         int id0, int id1, 
    //                         g2o::SE3Quat& relpose);
    ...
    // double FindLoopEdgeScale(   int loop_edge_id, 
    //                             int curr_id, 
    //                             Map MapST, 
    //                             cv::Mat K_, 
    //                             std::vector<cv::Mat> map_point_inlier, 
    //                             cv::Mat &relpose);
    
    // double VerifyLoop(  int loop_edge_id, 
    //                     int curr_id, 
    //                     Map MapST, 
    //                     cv::Mat K_, 
    //                     cv::Mat& relpose);
